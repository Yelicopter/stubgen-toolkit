...
class AgentState:
    ...
    def initialize(self, dfs: Union[Union[DataFrame, VirtualDataFrame], List[Union[DataFrame, VirtualDataFrame]]], config: Optional[Union[Config, dict]] = ..., memory_size: Optional[int] = ..., vectorstore: Optional[VectorStore] = ..., description: str = ...): ...
