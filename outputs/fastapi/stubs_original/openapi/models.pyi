...
class ServerVariable(BaseModelWithConfig):
    enum: Annotated[Optional[List[str]], None]
    default: str
    description: Optional[str]
...
class Schema(BaseModelWithConfig):
    ...
    defs: Optional[Dict[str, 'SchemaOrBool']]
    ...
    items: Optional[Union['SchemaOrBool', List['SchemaOrBool']]]
    ...
    example: Annotated[Optional[Any], None]
